...
class ImagesZoom{
  ...
  init (param) {
    ...
    var imgList = document.querySelectorAll(params.elem + " img")[0],
      zoomMask = document.querySelector(params.parentDom),
      zoomImg = document.querySelectorAll(params.elem + " img")[0],
      imgSrc = "";
